...
create table public.review_events (
  ...
  result_srs_status text not null check (result_srs_status in ('new', 'learning', 'known')),
  result_review_count integer not null check (result_review_count >= 0),
  result_success_streak integer not null check (result_success_streak >= 0),
  result_last_reviewed_at timestamptz,
